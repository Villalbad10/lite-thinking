package com.lite_thinking.app.exception;
...
public class ApiExceptionHandler {
	...
	@ExceptionHandler({
			com.lite_thinking.app.exception.NotFoundException.class,
			com.lite_thinking.app.exception.ResourceNotFoundException.class
	})
	@ResponseBody
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ExceptionHandler({
		com.lite_thinking.app.exception.BadRequestException.class,
	...
	@ExceptionHandler({
			com.lite_thinking.app.exception.ForbiddenException.class
	})
	@ResponseBody
	...
	@ExceptionHandler({
		...
		com.lite_thinking.app.exception.ConflictException.class
	})
	@ResponseBody
	...
	@ExceptionHandler({
			com.lite_thinking.app.exception.UnauthorizedException.class
	})
